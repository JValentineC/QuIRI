        ...
        <div className="hero-content text-center">
          <div className="max-w-md">
            ...
            <p className="py-6 text-lg">
              Connect with the quantum community through conferences, workshops, and seminars
            </p>
          </div>
        </div>
      </div>
          ...
          {filteredEvents.map((event) => (
            <div
              ...
              className={`card bg-base-100 shadow-xl hover:shadow-2xl transition-shadow duration-300 ${
                isUpcoming(event.startDate) ? 'border-l-4 border-l-primary' : 'opacity-75'
              }`}
            >
              <div className="card-body">
                {/* Event Status */}
                <div className="flex justify-between items-start mb-4">
                  <div className={`badge ${isUpcoming(event.startDate) ? 'badge-success' : 'badge-neutral'}`}>
                ...
                <div className="flex justify-between items-center text-sm mb-4">
                  ...
                  <div className={`badge ${event.registrationOpen ? 'badge-success' : 'badge-error'}`}>
        ...
        {filteredEvents.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-base-content/60">
              {selectedFilter === "upcoming" && "No upcoming events at this time."}
          ...
          <div className="card bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/20">
            <div className="card-body">
              ...
              <p className="text-center text-base-content/80 mb-6">
                Organize workshops, seminars, or conferences to bring together the quantum
                science community and share knowledge.
              </p>
              <div className="card-actions justify-center">
                <button className="btn btn-primary btn-lg">Create Event</button>
                <button className="btn btn-outline btn-lg">Event Guidelines</button>
              </div>
            </div>
          </div>
        </div>
